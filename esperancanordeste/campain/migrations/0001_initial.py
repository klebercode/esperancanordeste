...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        return
        # # Adding model 'Entry'
        # db.create_table(u'campain_entry', (
        ...
        #     ('video', self.gf('embed_video.fields.EmbedVideoField')(max_length=200, null=True, blank=True)),
        ...
        # ))
        # db.send_create_signal(u'campain', ['Entry'])


    def backwards(self, orm):
        # Deleting model 'Entry'
        db.delete_table(u'campain_entry')
